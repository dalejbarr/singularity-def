type <- "clmm"
dgp_file <- "/opt/data/clmm_maximal.rds" # location of file with fitted model to use as DGP
slists_file <- "/opt/data/stim_lists.rds" # location of file with stimulus lists
...
if (!interactive()) {
  fname <- sprintf("%s_%04d_0128_%05d_%0.2f_%s_%d.rds",
